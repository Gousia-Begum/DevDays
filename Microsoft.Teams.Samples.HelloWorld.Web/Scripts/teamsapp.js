(function () {
  ...
  microsoftTeams.settings.registerOnSaveHandler(function (saveEvent) {
    ...
    microsoftTeams.settings.setSettings({
        contentUrl: window.location.protocol + '//' + window.location.host + '/Index', // Mandatory parameter
        entityId: window.location.protocol + '//' + window.location.host + '/Index'// Mandatory parameter
    });
